...
- **最近更新**:2026-09-04,模拟面试综合报告评分展示二轮优化(信息压缩):评分区改**双列横排评分摘要**——「6.0 / 10 + 内容能力」「5.0 / 10 + 表达能力」两列各上下成组,一行动态注记「已评估 X / N 题 · 阶段性评分 / 面试评分已完成」居中于下方;删除冗余「评分标准:…」辅助行(「/ 10」已明示满分);917/917 测试全绿、typecheck/lint 零错误、build 成功;数据逻辑零改动
