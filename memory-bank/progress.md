...
- **最近更新**:2026-09-04,简历中心核心内容区加宽:移除页级 860px 硬编码容器,复用全局 1160px 内容容器(与工作台/画像/路线图/匹配/简历优化同宽);「我的简历」列表行信息区 flex-1 占满剩余宽度(文件名 truncate)、操作按钮组靠右不散开、整行垂直居中;功能与数据逻辑零改动
